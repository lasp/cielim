...
/* Purpose: The camera navigates the scene and has view and projection matrices. The camera (view) space coordinate
 * system is right-handed Z-up. */
...
public:
    ...
    [[nodiscard]] auto get_projection_matrix() const -> math::Mat4
    {
        ...
        return math::perspective_infinite_reverse_z_aspect(this->aspect_, this->fov_y_, this->near_plane_distance_);
    }
