...
public:
     ...
     * @details Only valid if the buffer was created with VMA_ALLOCATION_CREATE_MAPPED_BIT and thus whose memory is
     * host-visible. Bypasses the use of a staging buffer.
