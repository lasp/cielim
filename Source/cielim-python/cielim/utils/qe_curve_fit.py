...
# Written alongside every other saved figure set rather than into a documentation tree.
# showcase_images is not gitignored, so these PDFs are committable alongside the paper.
