...
PROTOBUF_ATTRIBUTE_NO_DESTROY PROTOBUF_CONSTINIT ReflectanceModelDefaultTypeInternal _ReflectanceModel_default_instance_;
...
::PROTOBUF_NAMESPACE_ID::uint8* TimeStamp::_InternalSerialize(
  ...
  // double simTimeElapsed = 2;
  if (!(this->_internal_simtimeelapsed() <= 0 && this->_internal_simtimeelapsed() >= 0)) {
    target = stream->EnsureSpace(target);
...
// @@protoc_insertion_point(message_byte_size_start:cielimMessage.TimeStamp)
  ...
  // int64 frameNumber = 1;
  if (this->_internal_framenumber() != 0) {
    total_size += ::PROTOBUF_NAMESPACE_ID::internal::WireFormatLite::Int64SizePlusOne(this->_internal_framenumber());
  }
...
// @@protoc_insertion_point(class_specific_merge_from_start:cielimMessage.TimeStamp)
  ...
  if (!(from._internal_simtimeelapsed() <= 0 && from._internal_simtimeelapsed() >= 0)) {
...
inline void EpochDateTime::SharedDtor() {
  GOOGLE_DCHECK(GetArenaForAllocation() == nullptr);
}
...
::PROTOBUF_NAMESPACE_ID::uint8* EpochDateTime::_InternalSerialize(
  ...
  // double seconds = 6;
  if (!(this->_internal_seconds() <= 0 && this->_internal_seconds() >= 0)) {
    target = stream->EnsureSpace(target);
...
// @@protoc_insertion_point(class_specific_merge_from_start:cielimMessage.EpochDateTime)
  ...
  if (!(from._internal_seconds() <= 0 && from._internal_seconds() >= 0)) {
...
RenderingModel::RenderingModel(const RenderingModel& from)
  ...
  ::memcpy(&wavelength1_, &from.wavelength1_,
    static_cast<size_t>(reinterpret_cast<char*>(&enablesmear_) -
    reinterpret_cast<char*>(&wavelength1_)) + sizeof(enablesmear_));
...
rendering_.UnsafeSetDefault(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited());
::memset(reinterpret_cast<char*>(this) + static_cast<size_t>(
    reinterpret_cast<char*>(&wavelength1_) - reinterpret_cast<char*>(this)),
...
inline void RenderingModel::SharedDtor() {
  GOOGLE_DCHECK(GetArenaForAllocation() == nullptr);
...
// @@protoc_insertion_point(message_clear_start:cielimMessage.RenderingModel)
  ...
  ::memset(&wavelength1_, 0, static_cast<size_t>(
    ...
    switch (tag >> 3) {
      ...
      case 1:
        if (PROTOBUF_PREDICT_TRUE(static_cast<::PROTOBUF_NAMESPACE_ID::uint8>(tag) == 9)) {
          wavelength1_ = ::PROTOBUF_NAMESPACE_ID::internal::UnalignedLoad<double>(ptr);
          ptr += sizeof(double);
        } else
          goto handle_unusual;
        continue;
      ...
      case 2:
        if (PROTOBUF_PREDICT_TRUE(static_cast<::PROTOBUF_NAMESPACE_ID::uint8>(tag) == 17)) {
          wavelength2_ = ::PROTOBUF_NAMESPACE_ID::internal::UnalignedLoad<double>(ptr);
          ptr += sizeof(double);
        } else
          goto handle_unusual;
        continue;
      ...
      case 3:
        if (PROTOBUF_PREDICT_TRUE(static_cast<::PROTOBUF_NAMESPACE_ID::uint8>(tag) == 25)) {
          wavelength3_ = ::PROTOBUF_NAMESPACE_ID::internal::UnalignedLoad<double>(ptr);
          ptr += sizeof(double);
        } else
          goto handle_unusual;
        continue;
...
::PROTOBUF_NAMESPACE_ID::uint8* RenderingModel::_InternalSerialize(
  ...
  // double wavelength1 = 1;
  if (!(this->_internal_wavelength1() <= 0 && this->_internal_wavelength1() >= 0)) {
    target = stream->EnsureSpace(target);
    target = ::PROTOBUF_NAMESPACE_ID::internal::WireFormatLite::WriteDoubleToArray(1, this->_internal_wavelength1(), target);
  }

  // double wavelength2 = 2;
  if (!(this->_internal_wavelength2() <= 0 && this->_internal_wavelength2() >= 0)) {
    target = stream->EnsureSpace(target);
    target = ::PROTOBUF_NAMESPACE_ID::internal::WireFormatLite::WriteDoubleToArray(2, this->_internal_wavelength2(), target);
  }

  // double wavelength3 = 3;
  if (!(this->_internal_wavelength3() <= 0 && this->_internal_wavelength3() >= 0)) {
    target = stream->EnsureSpace(target);
    target = ::PROTOBUF_NAMESPACE_ID::internal::WireFormatLite::WriteDoubleToArray(3, this->_internal_wavelength3(), target);
  }

  // double cosmicRayStdDeviation = 4;
  if (!(this->_internal_cosmicraystddeviation() <= 0 && this->_internal_cosmicraystddeviation() >= 0)) {
    target = stream->EnsureSpace(target);
    target = ::PROTOBUF_NAMESPACE_ID::internal::WireFormatLite::WriteDoubleToArray(4, this->_internal_cosmicraystddeviation(), target);
  }

  // double strayLight = 5;
  if (!(this->_internal_straylight() <= 0 && this->_internal_straylight() >= 0)) {
    target = stream->EnsureSpace(target);
    target = ::PROTOBUF_NAMESPACE_ID::internal::WireFormatLite::WriteDoubleToArray(5, this->_internal_straylight(), target);
  }

  // bool starField = 6;
  if (this->_internal_starfield() != 0) {
    target = stream->EnsureSpace(target);
    target = ::PROTOBUF_NAMESPACE_ID::internal::WireFormatLite::WriteBoolToArray(6, this->_internal_starfield(), target);
  }

  // string rendering = 7;
  if (!this->_internal_rendering().empty()) {
    ...
    target = stream->WriteStringMaybeAliased(
        7, this->_internal_rendering(), target);
  }

  // bool enableSmear = 8;
  if (this->_internal_enablesmear() != 0) {
    target = stream->EnsureSpace(target);
    target = ::PROTOBUF_NAMESPACE_ID::internal::WireFormatLite::WriteBoolToArray(8, this->_internal_enablesmear(), target);
  }
...
// @@protoc_insertion_point(class_specific_merge_from_start:cielimMessage.RenderingModel)
  ...
  if (!(from._internal_wavelength1() <= 0 && from._internal_wavelength1() >= 0)) {
    _internal_set_wavelength1(from._internal_wavelength1());
  }
  if (!(from._internal_wavelength2() <= 0 && from._internal_wavelength2() >= 0)) {
    _internal_set_wavelength2(from._internal_wavelength2());
  }
  if (!(from._internal_wavelength3() <= 0 && from._internal_wavelength3() >= 0)) {
    _internal_set_wavelength3(from._internal_wavelength3());
  }
  if (!(from._internal_cosmicraystddeviation() <= 0 && from._internal_cosmicraystddeviation() >= 0)) {
    _internal_set_cosmicraystddeviation(from._internal_cosmicraystddeviation());
  }
  if (!(from._internal_straylight() <= 0 && from._internal_straylight() >= 0)) {
...
void RenderingModel::InternalSwap(RenderingModel* other) {
  ...
  ::PROTOBUF_NAMESPACE_ID::internal::ArenaStringPtr::InternalSwap(
      ...
      &other->rendering_, rhs_arena
  );
  ::PROTOBUF_NAMESPACE_ID::internal::memswap<
      PROTOBUF_FIELD_OFFSET(RenderingModel, enablesmear_)
      + sizeof(RenderingModel::enablesmear_)
      - PROTOBUF_FIELD_OFFSET(RenderingModel, wavelength1_)>(
          reinterpret_cast<char*>(&wavelength1_),
          reinterpret_cast<char*>(&other->wavelength1_));
}
...
ReflectanceModel::ReflectanceModel(::PROTOBUF_NAMESPACE_ID::Arena* arena,
                         bool is_message_owned)
  : ::PROTOBUF_NAMESPACE_ID::MessageLite(arena, is_message_owned),
...
ReflectanceModel::ReflectanceModel(const ReflectanceModel& from)
  : ::PROTOBUF_NAMESPACE_ID::MessageLite(),
...
inline void ReflectanceModel::SharedDtor() {
  GOOGLE_DCHECK(GetArenaForAllocation() == nullptr);
  brdfmodel_.DestroyNoArena(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited());
}

void ReflectanceModel::ArenaDtor(void* object) {
  ReflectanceModel* _this = reinterpret_cast< ReflectanceModel* >(object);
  (void)_this;
}
void ReflectanceModel::RegisterArenaDtor(::PROTOBUF_NAMESPACE_ID::Arena*) {
}
void ReflectanceModel::SetCachedSize(int size) const {
  _cached_size_.Set(size);
}

void ReflectanceModel::Clear() {
...
const char* ReflectanceModel::_InternalParse(const char* ptr, ::PROTOBUF_NAMESPACE_ID::internal::ParseContext* ctx) {
#define CHK_(x) if (PROTOBUF_PREDICT_FALSE(!(x))) goto failure
  while (!ctx->Done(&ptr)) {
    ::PROTOBUF_NAMESPACE_ID::uint32 tag;
    ptr = ::PROTOBUF_NAMESPACE_ID::internal::ReadTag(ptr, &tag);
...
::PROTOBUF_NAMESPACE_ID::uint8* ReflectanceModel::_InternalSerialize(
    ::PROTOBUF_NAMESPACE_ID::uint8* target, ::PROTOBUF_NAMESPACE_ID::io::EpsCopyOutputStream* stream) const {
...
void ReflectanceModel::CheckTypeAndMergeFrom(
    const ::PROTOBUF_NAMESPACE_ID::MessageLite& from) {
  MergeFrom(*::PROTOBUF_NAMESPACE_ID::internal::DownCast<const ReflectanceModel*>(
      &from));
}

void ReflectanceModel::MergeFrom(const ReflectanceModel& from) {
...
bool ReflectanceModel::IsInitialized() const {
  return true;
}

void ReflectanceModel::InternalSwap(ReflectanceModel* other) {
  using std::swap;
  auto* lhs_arena = GetArenaForAllocation();
  auto* rhs_arena = other->GetArenaForAllocation();
  _internal_metadata_.InternalSwap(&other->_internal_metadata_);
...
class MeshModel::_Internal {
 public:
  static const ::cielimMessage::ReflectanceModel& refmodel(const MeshModel* msg);
  static const ::cielimMessage::PerlinNoise& perlinnoise(const MeshModel* msg);
};

const ::cielimMessage::ReflectanceModel&
MeshModel::_Internal::refmodel(const MeshModel* msg) {
  return *msg->refmodel_;
}
...
MeshModel::MeshModel(const MeshModel& from)
  ...
  if (from._internal_has_refmodel()) {
    refmodel_ = new ::cielimMessage::ReflectanceModel(*from.refmodel_);
  } else {
    refmodel_ = nullptr;
  }
  ...
  ::memcpy(&meanradius_, &from.meanradius_,
    static_cast<size_t>(reinterpret_cast<char*>(&proceduralrocks_) -
    reinterpret_cast<char*>(&meanradius_)) + sizeof(proceduralrocks_));
...
shapemodel_.UnsafeSetDefault(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited());
::memset(reinterpret_cast<char*>(this) + static_cast<size_t>(
    reinterpret_cast<char*>(&refmodel_) - reinterpret_cast<char*>(this)),
    0, static_cast<size_t>(reinterpret_cast<char*>(&proceduralrocks_) -
    reinterpret_cast<char*>(&refmodel_)) + sizeof(proceduralrocks_));
}
...
inline void MeshModel::SharedDtor() {
  ...
  if (this != internal_default_instance()) delete refmodel_;
...
// @@protoc_insertion_point(message_clear_start:cielimMessage.MeshModel)
  ...
  perlinnoise_ = nullptr;
  ::memset(&meanradius_, 0, static_cast<size_t>(
      reinterpret_cast<char*>(&proceduralrocks_) -
      reinterpret_cast<char*>(&meanradius_)) + sizeof(proceduralrocks_));
  _internal_metadata_.Clear<std::string>();
}
...
::PROTOBUF_NAMESPACE_ID::uint8* MeshModel::_InternalSerialize(
  ...
  // string shapeModel = 1;
  if (!this->_internal_shapemodel().empty()) {
    ::PROTOBUF_NAMESPACE_ID::internal::WireFormatLite::VerifyUtf8String(
  ...
  // double meanRadius = 2;
  if (!(this->_internal_meanradius() <= 0 && this->_internal_meanradius() >= 0)) {
    target = stream->EnsureSpace(target);
...
// @@protoc_insertion_point(class_specific_merge_from_start:cielimMessage.MeshModel)
  ...
  if (from._internal_has_refmodel()) {
    _internal_mutable_refmodel()->::cielimMessage::ReflectanceModel::MergeFrom(from._internal_refmodel());
  }
  if (from._internal_has_perlinnoise()) {
...
void MeshModel::InternalSwap(MeshModel* other) {
  ...
  ::PROTOBUF_NAMESPACE_ID::internal::ArenaStringPtr::InternalSwap(
      &::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(),
      &shapemodel_, lhs_arena,
      &other->shapemodel_, rhs_arena
  );
  ::PROTOBUF_NAMESPACE_ID::internal::memswap<
      PROTOBUF_FIELD_OFFSET(MeshModel, proceduralrocks_)
      + sizeof(MeshModel::proceduralrocks_)
      - PROTOBUF_FIELD_OFFSET(MeshModel, refmodel_)>(
          reinterpret_cast<char*>(&refmodel_),
          reinterpret_cast<char*>(&other->refmodel_));
}
...
inline void CelestialBody::SharedDtor() {
  GOOGLE_DCHECK(GetArenaForAllocation() == nullptr);
...
::PROTOBUF_NAMESPACE_ID::uint8* CelestialBody::_InternalSerialize(
  ...
  // string bodyName = 1;
  if (!this->_internal_bodyname().empty()) {
    ::PROTOBUF_NAMESPACE_ID::internal::WireFormatLite::VerifyUtf8String(
...
inline void Spacecraft::SharedDtor() {
  GOOGLE_DCHECK(GetArenaForAllocation() == nullptr);
...
::PROTOBUF_NAMESPACE_ID::uint8* Spacecraft::_InternalSerialize(
  ...
  // string spacecraftName = 1;
  if (!this->_internal_spacecraftname().empty()) {
    ::PROTOBUF_NAMESPACE_ID::internal::WireFormatLite::VerifyUtf8String(
...
void Spacecraft::InternalSwap(Spacecraft* other) {
  ...
  ::PROTOBUF_NAMESPACE_ID::internal::ArenaStringPtr::InternalSwap(
      ...
      &other->spacecraftname_, rhs_arena
  );
}
...
QuantumEfficiency::QuantumEfficiency(const QuantumEfficiency& from)
  ...
  ::memcpy(&integrationweightfactor_, &from.integrationweightfactor_,
    static_cast<size_t>(reinterpret_cast<char*>(&bluevalue3_) -
    reinterpret_cast<char*>(&integrationweightfactor_)) + sizeof(bluevalue3_));
...
::memset(reinterpret_cast<char*>(this) + static_cast<size_t>(
    ...
    0, static_cast<size_t>(reinterpret_cast<char*>(&bluevalue3_) -
    reinterpret_cast<char*>(&integrationweightfactor_)) + sizeof(bluevalue3_));
}
...
// @@protoc_insertion_point(message_clear_start:cielimMessage.QuantumEfficiency)
  ...
  ::memset(&integrationweightfactor_, 0, static_cast<size_t>(
      reinterpret_cast<char*>(&bluevalue3_) -
      reinterpret_cast<char*>(&integrationweightfactor_)) + sizeof(bluevalue3_));
  _internal_metadata_.Clear<std::string>();
}
...
void QuantumEfficiency::InternalSwap(QuantumEfficiency* other) {
  ...
  _internal_metadata_.InternalSwap(&other->_internal_metadata_);
  ::PROTOBUF_NAMESPACE_ID::internal::memswap<
      PROTOBUF_FIELD_OFFSET(QuantumEfficiency, bluevalue3_)
      + sizeof(QuantumEfficiency::bluevalue3_)
...
parentname_.UnsafeSetDefault(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited());
::memset(reinterpret_cast<char*>(this) + static_cast<size_t>(
    reinterpret_cast<char*>(&lensmodel_) - reinterpret_cast<char*>(this)),
    0, static_cast<size_t>(reinterpret_cast<char*>(&cameraid_) -
    reinterpret_cast<char*>(&lensmodel_)) + sizeof(cameraid_));
}
...
inline void CameraModel::SharedDtor() {
  GOOGLE_DCHECK(GetArenaForAllocation() == nullptr);
...
::PROTOBUF_NAMESPACE_ID::uint8* CameraModel::_InternalSerialize(
  ...
  if (this->_internal_has_lensmodel()) {
    ...
    target = ::PROTOBUF_NAMESPACE_ID::internal::WireFormatLite::
      InternalWriteMessage(
        5, _Internal::lensmodel(this), target, stream);
  }
...
void CameraModel::InternalSwap(CameraModel* other) {
  ...
  ::PROTOBUF_NAMESPACE_ID::internal::ArenaStringPtr::InternalSwap(
      &::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(),
      &parentname_, lhs_arena,
      &other->parentname_, rhs_arena
  );
  ::PROTOBUF_NAMESPACE_ID::internal::memswap<
      PROTOBUF_FIELD_OFFSET(CameraModel, cameraid_)
      + sizeof(CameraModel::cameraid_)
      - PROTOBUF_FIELD_OFFSET(CameraModel, lensmodel_)>(
          reinterpret_cast<char*>(&lensmodel_),
          reinterpret_cast<char*>(&other->lensmodel_));
}
...
class CielimMessage::_Internal {
 public:
  ...
  static const ::cielimMessage::RenderingModel& renderparameters(const CielimMessage* msg);
...
CielimMessage::_Internal::renderparameters(const CielimMessage* msg) {
...
inline void CielimMessage::SharedDtor() {
  GOOGLE_DCHECK(GetArenaForAllocation() == nullptr);
...
::PROTOBUF_NAMESPACE_ID::uint8* CielimMessage::_InternalSerialize(
  ...
  // .cielimMessage.TimeStamp currentTime = 2;
  if (this->_internal_has_currenttime()) {
    target = stream->EnsureSpace(target);
    target = ::PROTOBUF_NAMESPACE_ID::internal::WireFormatLite::
      InternalWriteMessage(
  ...
  if (this->_internal_has_renderparameters()) {
    ...
    target = ::PROTOBUF_NAMESPACE_ID::internal::WireFormatLite::
      InternalWriteMessage(
        3, _Internal::renderparameters(this), target, stream);
  }
  ...
  for (unsigned int i = 0,
    ...
    target = stream->EnsureSpace(target);
    target = ::PROTOBUF_NAMESPACE_ID::internal::WireFormatLite::
      InternalWriteMessage(4, this->_internal_celestialbodies(i), target, stream);
  }

  // .cielimMessage.Spacecraft spacecraft = 5;
  if (this->_internal_has_spacecraft()) {
    target = stream->EnsureSpace(target);
    target = ::PROTOBUF_NAMESPACE_ID::internal::WireFormatLite::
      InternalWriteMessage(
        5, _Internal::spacecraft(this), target, stream);
  }
  ...
  if (this->_internal_has_camera()) {
    ...
    target = ::PROTOBUF_NAMESPACE_ID::internal::WireFormatLite::
      InternalWriteMessage(
        6, _Internal::camera(this), target, stream);
  }
...
template<> PROTOBUF_NOINLINE ::cielimMessage::ReflectanceModel* Arena::CreateMaybeMessage< ::cielimMessage::ReflectanceModel >(Arena* arena) {
  return Arena::CreateMessageInternal< ::cielimMessage::ReflectanceModel >(arena);
}
